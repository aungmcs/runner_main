...
//=========================================================
  ...
  if ( dist_frontLeft > 0.00 && dist_frontLeft < 7.00 && sonarHelp == 2){
 ...
 }else if (dist_frontRight > 0.00 && dist_frontRight < 7.00 && sonarHelp == 2){
 ...
 //else if (sonarHelp == 3 && dist_frontRight > 7.00){
 //   analogWrite(pwm_left, bit_left);
 //   analogWrite(pwm_right, bit_right + 20);
 //
 // }
